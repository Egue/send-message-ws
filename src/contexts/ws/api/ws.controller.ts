...
export class WsController {
  ...
  constructor(
    private readonly saludo: SaludoService,
    private readonly factura: FacturaService,
    private portal: MenuPortalService,
    private readonly volverInicio: VolverIncio,
    private readonly volverFactura: VolverFacturaService
  ) {}
  ...
  async run() {
    await createBot({
      flow: createFlow([
        this.saludo.flujoMensajeSaludo,
        this.factura.flujoFactura,
        this.portal.flujoMenuPortal,
        this.volverInicio.flujoMenuInicio,
        this.volverFactura.flujoVolverFactura
      ]),
